...
Additionally, you can pass an executor in throught arguments using `asio::executor_arg`.

NOTE: Task is executor and thus thread-aware. I.e. it is safe to await from another thread.
