...
BOOST_COBALT_DECL BOOST_NORETURN void
...
struct ip_address_v4
{
    ...
    BOOST_COBALT_DECL static_string<15> addr_str() const;
 private:
  union {
    boost::asio::detail::sockaddr_storage_type addr_{};
...
struct ip_address_v6
{
  ...
  BOOST_COBALT_DECL static_string<45> addr_str() const;
 private:
  union {
    boost::asio::detail::sockaddr_storage_type addr_{};
...
struct ip_address
{
  ...
  BOOST_COBALT_DECL std::array<std::uint8_t, 16u> addr() const;
  BOOST_COBALT_DECL static_string<45> addr_str() const;
 private:
  union {
    boost::asio::detail::sockaddr_storage_type addr_{};
