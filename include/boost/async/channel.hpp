...
template<typename T>
void channel<T>::async_receive(boost::async::completion_handler<system::error_code, T> h)
{
...
template<typename T>
void channel<T>::async_send(T && value, boost::async::completion_handler<system::error_code> h)
{
