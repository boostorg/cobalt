...
#ifndef BOOST_ASYNC_IO_TIMER_HIGH_RESOLUTION_TIMER_HPP
#define BOOST_ASYNC_IO_TIMER_HIGH_RESOLUTION_TIMER_HPP
...
struct high_resolution_timer final : concepts::implements<concepts::timer>
{
  /// The underlying asio implementation type.
  typedef asio::basic_waitable_timer<
      std::chrono::high_resolution_clock,
      asio::wait_traits<std::chrono::high_resolution_clock>,
  ...
  typedef asio::wait_traits<std::chrono::high_resolution_clock> traits_type;
   ...
   */
  explicit high_resolution_timer(const executor_type& ex);
   ...
   */
  explicit high_resolution_timer(asio::io_context& context);
   ...
   * as an absolute time.
   */
  high_resolution_timer(const executor_type& ex, const time_point& expiry_time);
   ...
   * now.
   */
  high_resolution_timer(const executor_type& ex, const duration& expiry_time);
   ...
   * now.
   */
  explicit high_resolution_timer(asio::io_context& context, const duration& expiry_time);
   ...
   * constructor.
   */
  high_resolution_timer(high_resolution_timer&& other);
   ...
   * constructor.
   */
  high_resolution_timer& operator=(high_resolution_timer&& other);
...
#endif //BOOST_ASYNC_IO_TIMER_HIGH_RESOLUTION_TIMER_HPP
