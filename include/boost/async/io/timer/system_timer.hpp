...
#ifndef BOOST_ASYNC_IO_TIMER_SYSTEM_TIMER_HPP
#define BOOST_ASYNC_IO_TIMER_SYSTEM_TIMER_HPP
...
struct system_timer final : concepts::implements<concepts::timer>
{
  ...
  typedef asio::wait_traits<std::chrono::system_clock> traits_type;
   ...
   */
  explicit system_timer(const executor_type& ex);
   ...
   */
  explicit system_timer(asio::io_context& context);
   ...
   * as an absolute time.
   */
  system_timer(const executor_type& ex, const time_point& expiry_time);
   ...
   * now.
   */
  system_timer(const executor_type& ex, const duration& expiry_time);
   ...
   * now.
   */
  explicit system_timer(asio::io_context& context, const duration& expiry_time);
   ...
   * constructor.
   */
  system_timer(system_timer&& other);
   ...
   * constructor.
   */
  system_timer& operator=(system_timer&& other);
...
#endif //BOOST_ASYNC_IO_TIMER_SYSTEM_TIMER_HPP
