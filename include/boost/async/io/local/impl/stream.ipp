...
void stream::socket::async_wait(wait_type w, boost::async::detail::completion_handler<system::error_code> h) { return impl_.async_wait(w, std::move(h)); }
void stream::socket::async_connect(const endpoint_type& peer_endpoint, boost::async::detail::completion_handler<system::error_code> h){return impl_.async_connect(peer_endpoint, std::move(h));}
void stream::socket::async_send(      const_buffer buffer, concepts::write_handler h)                           {return impl_.async_send(      buffer,        std::move(h));}
void stream::socket::async_send(      const_buffer buffer, message_flags flags, concepts::write_handler h)      {return impl_.async_send(      buffer, flags, std::move(h));}
void stream::socket::async_receive( mutable_buffer buffer, concepts::read_handler h)                            {return impl_.async_receive(   buffer,        std::move(h));}
void stream::socket::async_receive( mutable_buffer buffer, message_flags flags, concepts::read_handler h)       {return impl_.async_receive(   buffer, flags, std::move(h));}
void stream::socket::async_write_some(const_buffer buffer, concepts::write_handler h)                           {return impl_.async_write_some(buffer,        std::move(h));}
void stream::socket::async_write_some(prepared_buffers buffer, concepts::write_handler h)                       {return impl_.async_write_some(buffer,        std::move(h));}
void stream::socket::async_read_some(asio::mutable_buffer buffer,                     concepts::read_handler h) {return impl_.async_read_some( buffer,        std::move(h));}
void stream::socket::async_read_some(static_buffer_base::mutable_buffers_type buffer, concepts::read_handler h) {return impl_.async_read_some( buffer,        std::move(h));}
void stream::socket::async_read_some(multi_buffer::mutable_buffers_type buffer,       concepts::read_handler h) {return impl_.async_read_some( buffer,        std::move(h));}
...
void stream::acceptor::async_wait(wait_type w, boost::async::detail::completion_handler<system::error_code> h) { return impl_.async_wait(w, std::move(h)); }
