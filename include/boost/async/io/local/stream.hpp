...
#ifndef BOOST_ASYNC_IO_LOCAL_STREAM_HPP
#define BOOST_ASYNC_IO_LOCAL_STREAM_HPP
...
/// Provides ssl-oriented socket functionality.
/**
 * The basic_stream_socket class template provides asynchronous and blocking
 * ssl-oriented socket functionality.
 *
 * @par Thread Safety
 ...
 */
struct stream::socket final : concepts::implements<concepts::cancellable, concepts::closable, concepts::socket, concepts::stream, concepts::waitable_device>
{
  ...
  /// The endpoint type.
  typedef typename local::stream::endpoint endpoint_type;
 ...
 * @endcode
 */
struct stream::acceptor final : concepts::implements<concepts::cancellable, concepts::closable, concepts::waitable_device>, asio::socket_base
{
  /// The underlying asio implementation type.
  ...
  /// The endpoint type.
  typedef typename asio::local::stream_protocol::endpoint endpoint_type;
...
#endif //BOOST_ASYNC_IO_LOCAL_STREAM_HPP
