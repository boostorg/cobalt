...
#ifndef BOOST_ASYNC_IO_IP_UDP_HPP
#define BOOST_ASYNC_IO_IP_UDP_HPP
...
struct udp
{
  ...
  static asio::ip::udp v4() noexcept
  {
    return asio::ip::udp::v4();
  }

  /// Construct to represent the IPv6 UDP protocol.
  static asio::ip::udp v6() noexcept
  {
 ...
 private:
  ...
  explicit udp(int protocol_id, int protocol_family) noexcept
 ...
 */
struct udp::socket final : concepts::implements<concepts::cancellable, concepts::closable, concepts::socket, concepts::waitable_device>
{
  ...
  /// The protocol type.
  typedef typename asio::ip::udp protocol_type;

  /// The endpoint type.
  typedef typename asio::ip::udp::endpoint endpoint_type;
 ...
 * @e Shared @e objects: Unsafe.
 */
struct udp::resolver : concepts::implements<concepts::cancellable, concepts::closable, concepts::execution_context>,
                        asio::ip::resolver_base
{
  ...
  /// The protocol type.
  typedef asio::ip::udp protocol_type;

  /// The endpoint type.
  typedef typename protocol_type::endpoint endpoint_type;

  /// The results type.
  typedef asio::ip::basic_resolver_results<asio::ip::udp > results_type;
...
#endif //BOOST_ASYNC_IO_IP_UDP_HPP
