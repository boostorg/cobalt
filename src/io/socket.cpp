...
void socket::wait_op_::initiate(completion_handler<system::error_code> handler)
{
  return socket_.async_wait(wt_, std::move(handler));
}

void socket::connect_op_::initiate(completion_handler<system::error_code> handler)
{
