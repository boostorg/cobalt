...
void steady_timer::wait_op_::ready(async::handler<system::error_code> h)
{
  if (timer_->expired())
    h({});
}
void steady_timer::wait_op_::initiate(async::completion_handler<system::error_code> complete)
{
